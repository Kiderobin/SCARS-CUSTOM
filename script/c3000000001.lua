...
s.listed_names={74889525,3000000000}
function s.cfilter(c,ft,tp)
	return c:IsCode(74889525) and (ft>0 or (c:GetSequence()<5 and c:IsControler(tp))) and (c:IsFaceup() or c:IsControler(tp))
end
...
function s.filter(c,e,tp)
	return c:IsCode(3000000000) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
